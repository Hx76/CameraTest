...
public class SurfaceViewCamera2 extends SurfaceView {
    ...
    public SurfaceViewCamera2(Context context) {
        this(context, null);
    }

    public SurfaceViewCamera2(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SurfaceViewCamera2(Context context, AttributeSet attrs, int defStyleAttr) {
        this(context, attrs, defStyleAttr, 0);
    }

    public SurfaceViewCamera2(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
